        ...
        return new Promise((resolve)=>{
            ...
            const tick = ()=>{
                ...
                if (msec % 100 === 0) {
                    ...
                    if (sec < 4 && sec > 0) beep.play().then().catch((err)=>{
                        console.log(err);
                    });
                }
            };
    ...
    async mainCountdown() {
        ...
        for(let i = 0; i < numSet; i++){
            ...
            for(let j = 0; j < numExercise; j++){
                ...
                if (currNumE === numExercise && currNumS === numSet) finished.play().then().catch((err)=>{
                    console.log(err);
                });
                else rest.play().then().catch((err)=>{
                    console.log(err);
                });
